...
<nav class="navbar navbar-default">
   ...
   <section>
    <table border="0" align="center">
        <tr>
            <td width="100"><button id="nuevo-producto" class="btn btn-primary">Nueva Materia</button></td>
            ...
            <?php 
                    ...
                    while($registro2 = mysql_fetch_array($registro)){
                        echo '<tr>
                                ...
                                <td><a href="javascript:edita_usuario('.$registro2['id_estudiante'].');" class="glyphicon glyphicon-edit"></a> 
                                <a href="javascript:elimina_usuario('.$registro2['id_estudiante'].');" class="glyphicon glyphicon-remove-circle"></a></td>
                            </tr>';     
                    }
            ?>
        </table>

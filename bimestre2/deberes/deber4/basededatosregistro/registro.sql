...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-01-2016 a las 22:05:49
...
INSERT INTO `empleado` (`id`, `nombre`, `apellido`, `fechadenacimiento`, `direccion`, `telefono`, `estado_civil`, `departamento`, `provincia`, `canton`, `parroquia`) VALUES
(1, 'Gustavo', 'Guijarro', '19/09/1994', 'Solanda', '0970980120', 'gguijarro@inmedical.com.ec', 'desarrollo', '', '', ''),
(2, 'Manuel', 'Ortega', '12/05/2000', 'Carapungo', '0980450010', 'rarboleda@inmedical.com.ec', 'Mantenimiento', '', '', ''),
(3, 'David', 'Fernandez', '15/09/1912', 'Calderon', '0982785836', 'fgbsdbnsd@hotmai..com', 'Desarrollo', '', '', '');
...
('dsa', 'gguijarro@inmedical.com.ec', '0986292922', 'solnada', 'gguijarro', '99e2aee00ec0c0522687');
...
ALTER TABLE `provincias`
 ADD PRIMARY KEY (`cod_provincia`), ADD UNIQUE KEY `provincia` (`provincia`);

...
<form method="post" name="formulario">
	    ...
	    PROVINCIA: 
             ...
             <?php foreach($provincias_cantones_parroquias as $indice=> $valor1): ?>  
                    <?php foreach($valor1 as $indice2=>$valor2): ?>
                        <option value="<?php echo $indice ?>"><?php echo $valor2 ?></option>
                    <?php endforeach; ?>  
             <?php endforeach; ?>  
             </select> 
        ...
        CANTON: 
             ...
             <?php foreach($provincias_cantones_parroquias as $indice=>$valor1 ): ?> 
                    <?php foreach($valor1 as $indice2 =>$valor2): ?>
                    	  <?php foreach($valor2 as $indice3=>$valor3): ?>
                    	  	  <?php foreach($valor3 as $indice4=>$valor4 ): ?>
                    	  	      <option value="<?php echo $indice3 ?>"><?php echo $valor4?></option>
                    	      <?php endforeach; ?> 
                          <?php endforeach; ?> 
                   <?php endforeach; ?>   
               <?php endforeach; ?>   
             ...
             <?php foreach($provincias_cantones_parroquias as $indice=>$valor1 ): ?> 
                    <?php foreach($valor1 as $indice2 =>$valor2): ?>
                    	  <?php foreach($valor2 as $indice3=>$valor3): ?>
                    	  	  <?php foreach($valor3 as $indice4=>$valor4): ?>
                    	  	  	 <?php foreach($valor4 as $indice5=>$valor5): ?>
                    	  	                   <option value="<?php echo $indice5 ?>"><?php echo $valor5?></option>
                    	    	    <?php endforeach;?> 
                                 <?php endforeach; ?> 
                          <?php endforeach; ?> 
                   <?php endforeach; ?>   
             ...
             <br>
             <div>
        <input type="submit" name="ENVIAR" style="margin-left:550px">
        </div>
